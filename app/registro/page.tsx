...
export default function RegistroPage() {
  ...
  async function loadExistingData() {
    try {
      ...
      nextForm.renovacionPct = existing.medofis?.renovacionPct ?? ""
      ...
      nextForm.cartera_comunidades = existing.cartera?.particulares?.comunidades ?? ""
      ...
      nextForm.prod_comunidades = existing.produccion?.particulares?.comunidades ?? ""
  ...
  return (
    <div className="space-y-8">
      ...
      <Section title="Indicadores Medofis" defaultOpen>
        ...
        <Input label="% Crecimiento" name="crecimientoPct" value={form.crecimientoPct} update={updateField} />
        <Input label="Renovación %" name="renovacionPct" value={form.renovacionPct} update={updateField} />
        <Input label="Tasa NP %" name="tasaNpPct" value={form.tasaNpPct} update={updateField} />
        <Input label="COR" name="cor" value={form.cor} update={updateField} />
        <Input label="% Devueltos" name="devolucionesPct" value={form.devolucionesPct} update={updateField} />
      </Section>

      <Section title="Cartera (GWP)" defaultOpen>
        <SubSection title="Particulares">
          <Input label="Auto" name="cartera_auto" value={form.cartera_auto} update={updateField} />
          <Input label="Hogar" name="cartera_hogar" value={form.cartera_hogar} update={updateField} />
          <Input label="Comunidades" name="cartera_comunidades" value={form.cartera_comunidades} update={updateField} />
          <Input label="Decesos" name="cartera_decesos" value={form.cartera_decesos} update={updateField} />
          <Input label="RC Particulares" name="cartera_rc_part" value={form.cartera_rc_part} update={updateField} />
          <Input label="Salud Individual" name="cartera_salud_ind" value={form.cartera_salud_ind} update={updateField} />
          <Input label="Total Particulares" name="cartera_part_total" value={form.cartera_part_total} update={updateField} />
        </SubSection>

        <SubSection title="Empresa">
          <Input label="RC" name="cartera_rc_emp" value={form.cartera_rc_emp} update={updateField} />
          <Input label="Flotas" name="cartera_flotas" value={form.cartera_flotas} update={updateField} />
          <Input label="Comercio" name="cartera_comercio" value={form.cartera_comercio} update={updateField} />
          <Input label="Oficina" name="cartera_oficina" value={form.cartera_oficina} update={updateField} />
          <Input label="Industria" name="cartera_industria" value={form.cartera_industria} update={updateField} />
          <Input label="Transporte" name="cartera_transporte" value={form.cartera_transporte} update={updateField} />
          <Input label="Total Empresa" name="cartera_emp_total" value={form.cartera_emp_total} update={updateField} />
        </SubSection>

        <SubSection title="Vida">
          <Input label="Vida Individual" name="cartera_vida_ind" value={form.cartera_vida_ind} update={updateField} />
          <Input label="Ahorro" name="cartera_ahorro" value={form.cartera_ahorro} update={updateField} />
        </SubSection>

        <SubSection title="PSC">
          <Input label="Vida Colectivo" name="cartera_vida_col" value={form.cartera_vida_col} update={updateField} />
          <Input label="Salud Colectivo" name="cartera_salud_col" value={form.cartera_salud_col} update={updateField} />
          <Input label="Total PSC" name="cartera_psc_total" value={form.cartera_psc_total} update={updateField} />
        </SubSection>
      </Section>

      <Section title="Producción (GWPNP)" defaultOpen={false}>
        <SubSection title="Particulares">
          <Input label="Auto" name="prod_auto" value={form.prod_auto} update={updateField} />
          <Input label="Hogar" name="prod_hogar" value={form.prod_hogar} update={updateField} />
          <Input label="Comunidades" name="prod_comunidades" value={form.prod_comunidades} update={updateField} />
          <Input label="Decesos" name="prod_decesos" value={form.prod_decesos} update={updateField} />
          <Input label="RC Particulares" name="prod_rc_part" value={form.prod_rc_part} update={updateField} />
          <Input label="Salud Individual" name="prod_salud_ind" value={form.prod_salud_ind} update={updateField} />
          <Input label="Total Particulares" name="prod_part_total" value={form.prod_part_total} update={updateField} />
        </SubSection>

        <SubSection title="Empresa">
          <Input label="RC" name="prod_rc_emp" value={form.prod_rc_emp} update={updateField} />
          <Input label="Flotas" name="prod_flotas" value={form.prod_flotas} update={updateField} />
          <Input label="Comercio" name="prod_comercio" value={form.prod_comercio} update={updateField} />
          <Input label="Oficina" name="prod_oficina" value={form.prod_oficina} update={updateField} />
          <Input label="Industria" name="prod_industria" value={form.prod_industria} update={updateField} />
          <Input label="Transporte" name="prod_transporte" value={form.prod_transporte} update={updateField} />
          <Input label="Total Empresa" name="prod_emp_total" value={form.prod_emp_total} update={updateField} />
        </SubSection>

        <SubSection title="Vida">
          <Input label="Vida Individual" name="prod_vida_ind" value={form.prod_vida_ind} update={updateField} />
          <Input label="Ahorro" name="prod_ahorro" value={form.prod_ahorro} update={updateField} />
        </SubSection>

        <SubSection title="PSC">
          <Input label="Vida Colectivo" name="prod_vida_col" value={form.prod_vida_col} update={updateField} />
          <Input label="Salud Colectivo" name="prod_salud_col" value={form.prod_salud_col} update={updateField} />
          <Input label="Total PSC" name="prod_psc_total" value={form.prod_psc_total} update={updateField} />
        </SubSection>
      </Section>
